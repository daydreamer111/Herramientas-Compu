...
def convolution(image, kernel):
    ...
    y devuelve la matriz resultante de la operacion
    """
...
img = cv2.imread("/home/pedros/Documents/Jackie/yop.jpeg")
matrix = [[1,1,1],[0,0,0],[-1,-1,-1]]
img = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)
prewitt_y = np.asarray(matrix)
convolution(img, prewitt_y)
